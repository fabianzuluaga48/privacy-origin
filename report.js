...
function loadData() {
  chrome.storage.local.get(["globalStats"], (result) => {
    ...
    // Total requests
    document.getElementById("total-requests").textContent = formatNumber(
